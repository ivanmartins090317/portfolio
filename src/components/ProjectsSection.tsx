  ...
  const projects = [
    {
      ...
      description: "Plataforma completa de e-commerce com pagamentos integrados, gestão de estoque e painel administrativo.",
    ...
    },
    {
      ...
      description: "Rede social com feed personalizado, sistema de mensagens e compartilhamento de mídia.",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Uma seleção dos meus trabalhos mais recentes, demonstrando diferentes tecnologias e soluções criativas.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-4 space-y-6">
            {projects.slice(1, 3).map((project, index) => (
              <Card key={project.title} className="p-4 hover:scale-105 transition-transform duration-300">
                <div className={`${project.image} h-24 rounded mb-3 flex items-center justify-center`}>
          ...
          <Card className="lg:col-span-12 p-6 hover:scale-105 transition-transform duration-300">
            <div className="grid md:grid-cols-4 gap-6 items-center">
              <div className={`${projects[3].image} h-32 rounded flex items-center justify-center`}>
              ...
              <div className="flex flex-col gap-2">
                ...
                <Button variant="outline" className="w-full">Código Fonte</Button>
              </div>
            </div>
          </Card>
        </div>
